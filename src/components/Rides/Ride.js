    ...
    <>
      <Col className="mb-4" lg="4">
        <Card>
          <Card.Body>
            ...
            <Card.Text as="div">
              <p className="m-0">
                <span className="fw-bold">Start location:</span>{" "}
                {ride.start_location}
              </p>
              <p className="m-0">
                <span className="fw-bold">End location:</span>{" "}
                {ride.end_location}
              </p>
              <p className="m-0">
            ...
            {currentUser ? (
              ride.user_id === currentUser.id ? (
                <Card.Link className="reservation-link text-decoration-none text-warning fw-bold">
                  Can't reserve own ride
                </Card.Link>
              ) : ride.space > 0 ? (
                <Card.Link
                  onClick={handleShow}
                  className="reservation-link text-decoration-none"
                >
                  Make a reservation
                </Card.Link>
              ) : (
                <Card.Link className="text-danger reservation-link text-decoration-none">
              ...
              <Card.Link
                as={Link}
                to="/login"
                className="reservation-link text-decoration-none text-warning fw-bold"
              >
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Reservation for {ride.user_id}'s ride</Modal.Title>
        </Modal.Header>
        <Modal.Body>
